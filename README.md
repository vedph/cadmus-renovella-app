...
3. build a new image for production: `docker build . -t vedph2020/cadmus-renovella-app:1.2.4-prod`. The production version is labeled like this one, with `-prod` suffix.
